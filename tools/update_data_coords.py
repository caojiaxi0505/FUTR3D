...
parser = argparse.ArgumentParser(description='由于坐标系重构而更新数据坐标的参数解析器')
parser.add_argument('dataset', metavar='kitti', help='数据集名称')
parser.add_argument('--root-dir', type=str, default='./data/kitti', help='指定数据集根目录')
parser.add_argument('--version', type=str, default='v1.0', required=False, help='指定数据集版本,kitti不需要')
parser.add_argument('--out-dir', type=str, default=None, required=False, help='info pkl的名称')
