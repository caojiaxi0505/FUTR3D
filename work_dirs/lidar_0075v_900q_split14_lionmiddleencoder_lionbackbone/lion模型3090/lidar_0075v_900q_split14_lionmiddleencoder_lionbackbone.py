...
log_level = 'INFO'
work_dir = './work_dirs/lidar_0075v_900q_split14_lionmiddleencoder_lionbackbone/lion模型3090'
load_from = None
resume_from = None
workflow = [('train', 1)]
...
model = dict(
    ...
    pts_middle_encoder=dict(
        ...
        model_cfg=dict(
            ...
            WINDOW_SHAPE=[[13, 13, 32], [13, 13, 16], [13, 13, 8], [13, 13,
                                                                    4]],
            ...
            OPERATOR=dict(
                NAME='Mamba',
                CFG=dict(d_state=16, d_conv=4, expand=2, drop_path=0.2))),
        input_channels=5,
