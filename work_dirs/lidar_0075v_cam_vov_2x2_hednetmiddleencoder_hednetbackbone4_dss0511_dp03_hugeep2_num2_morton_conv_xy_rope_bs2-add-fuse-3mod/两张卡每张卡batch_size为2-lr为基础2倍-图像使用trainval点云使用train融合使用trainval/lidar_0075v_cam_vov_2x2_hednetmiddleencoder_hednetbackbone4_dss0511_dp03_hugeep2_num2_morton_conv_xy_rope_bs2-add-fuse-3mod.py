...
data = dict(
    ...
    train=dict(
        ...
        data_root='data/nuscenes/',
        ann_file='data/nuscenes/nuscenes_infos_trainval.pkl',
        pipeline=[
            dict(type='LoadMultiViewImageFromFiles', to_float32=True),
            dict(
                type='LoadPointsFromFile',
...
log_level = 'INFO'
work_dir = './work_dirs/lidar_0075v_cam_vov_2x2_hednetmiddleencoder_hednetbackbone4_dss0511_dp03_hugeep2_num2_morton_conv_xy_rope_bs2-add-fuse-3mod/两张卡每张卡batch_size为2-lr为基础2倍-图像使用trainval点云使用train融合使用trainval'
