...
log_level = 'INFO'
work_dir = './work_dirs/lidar_0075v_900q_trainval_2x2_hednetmiddleencoder_hednetbackbone4_dss0511_dp03_hugeep2_layer2_morton_conv_xy_rope_stack/trainval'
load_from = None
resume_from = None
workflow = [('train', 1)]
