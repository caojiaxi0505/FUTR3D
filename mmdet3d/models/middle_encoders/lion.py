...
from mamba_ssm.modules.mamba_simple_lion import Block as MambaBlock
...
class LION3DBackboneOneStride(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        compression_cfg = dict(NUM_BEV_FEATURES=128)
        self.compression = HeightCompression(compression_cfg)
    ...
    def forward(self, batch_dict):
        ...
        batch_dict = self.compression(batch_dict)
        return batch_dict