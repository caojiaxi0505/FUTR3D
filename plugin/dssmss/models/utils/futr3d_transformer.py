        ...
        if use_dab:
            ...
            if self.no_sine_embed:
                ...
                self.ref_point_head = MLP(
                    d_model // 2 * self.anchor_size, d_model, d_model, 2
                )
        ...
        **kwargs
        ...
        for lid, layer in enumerate(self.layers):
            ...
            if reg_branches is not None:
                ...
                new_reference_points[..., 0:2] = tmp[..., 0:2] + inverse_sigmoid(
    ...
    def forward(
        ...
        **kwargs
        ...
        (
            ...
            level_start_index,
            valid_ratios,
        ) = self.feats_prepare(mlvl_pts_feats, mlvl_masks, mlvl_pos_embeds)
        (
            rad_feat_flatten,
            rad_mask_flatten,
            rad_lvl_pos_embed_flatten,
            rad_spatial_shapes,
            rad_level_start_index,
            rad_valid_ratios,
        ) = self.feats_prepare(radar_feats, mlvl_rad_masks, mlvl_rad_pos_embeds)
