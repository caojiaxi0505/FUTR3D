...
from plugin.custom.core.bbox.utils import normalize_bbox, denormalize_bbox
from plugin.custom.mamba.dss import DSS
        ...
        if use_dss:
            for lid in range(len(self.transformer.decoder.layers)):
                self.transformer.decoder.layers[lid].attentions[0] = DSS(
                    batch_first=dss_batch_first,
                    drop_prob=dss_drop_prob,
                    mamba_prenorm=dss_mamba_prenorm,
                    mamba_cfg=dss_mamba_cfg,
