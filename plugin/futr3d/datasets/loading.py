...
def reduce_LiDAR_beams(pts, reduce_beams_to=32, chosen_beam_id=13):
    ...
    # pick the 14th beam
        ...
        mask = (theta < (beam_range[chosen_beam_id[0] - 1] - 0.012)) * (
            theta > (beam_range[chosen_beam_id[0]] - 0.012)
        )
    ...
    def __call__(self, results):
        ...
        if self.pad_empty_sweeps and len(results["sweeps"]) == 0:
            ...
            for idx in choices:
                ...
                points_sweep = reduce_LiDAR_beams(
                    points_sweep, self.reduce_beams_to, self.chosen_beam_id
                )
