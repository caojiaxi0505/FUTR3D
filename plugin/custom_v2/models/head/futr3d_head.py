...
from plugin.custom_v2.core.bbox.utils import normalize_bbox, denormalize_bbox
from plugin.custom_v2.mamba.dss import DSS
...
class FUTR3DHead(DETRHead):
    ...
    def __init__(self,
        ...
        if use_dss:
            if use_hybrid:
                # use_hybrid为True时，仅仅将hybrid指定的层使用DSS替代，其他层使用自注意力机制
